...
/* PfzerCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PfzerCoin"
#define QAPP_ORG_DOMAIN "pfzercoin.online"
#define QAPP_APP_NAME_DEFAULT "PfzerCoin-Qt"
#define QAPP_APP_NAME_TESTNET "PfzerCoin-Qt-testnet"

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PfzerCoin pfzercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pfzercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pfzercoin transaction") + "\n" +
                               "  pfzercoin-tx [options] -create [commands]   " + _("Create hex-encoded pfzercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pfzercoin transaction

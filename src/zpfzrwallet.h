...
#ifndef PfzerCoin_ZPFZRWALLET_H
#define PfzerCoin_ZPFZRWALLET_H
...
public:
    CzpfzrWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZPFZR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPFZR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //PfzerCoin_ZPFZRWALLET_H

...
In order to support loading of multiple wallets in pfzercoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pfzercoin.cpp.
...
Changes to pfzercoin.cpp
----------------------
pfzercoin.cpp is the entry point into pfzercoin-qt, and as such, will require some minor modifications to provide hooks for

...
This mechanism has been integrated into Bitcore-Node-PfzerCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PfzerCoin-Project/insight-api-pfzercoin#web-socket-api](https://github.com/PfzerCoin-Project/insight-api-pfzercoin#web-socket-api) 
* API: [https://github.com/PfzerCoin-Project/insight-api-pfzercoin#swifttx-transactions](https://github.com/PfzerCoin-Project/insight-api-pfzercoin#swifttx-transactions) 
...
By default, the PfzerCoin daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PfzerCoin daemon:

Contributing to PfzerCoin
============================

The PfzerCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the PfzerCoin project, and is not to be
confused with overall PfzerCoin Network Protocol consensus changes.

Whether a pull request is merged into PfzerCoin rests with the project merge
...
Patches that change PfzerCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the PfzerCoin consensus, it must have been
...
The project leader is the release manager for each PfzerCoin release.

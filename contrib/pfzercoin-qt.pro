...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/pfzercoin-cli.cpp \
           src/pfzercoin-tx.cpp \
           src/pfzercoin.cpp \
           src/db.cpp \
           ...
           src/qt/pfzercoin.cpp \
           src/qt/pfzercoinstrings.cpp \
...
RESOURCES += src/qt/pfzercoin.qrc src/qt/pfzercoin_locale.qrc

TRANSLATIONS += src/qt/locale/pfzercoin_bg.ts \
                src/qt/locale/pfzercoin_de.ts \
                src/qt/locale/pfzercoin_en.ts \
                src/qt/locale/pfzercoin_es.ts \
                src/qt/locale/pfzercoin_fi.ts \
                src/qt/locale/pfzercoin_fr.ts \
                src/qt/locale/pfzercoin_it.ts \
                src/qt/locale/pfzercoin_ja.ts \
                src/qt/locale/pfzercoin_pl.ts \
                src/qt/locale/pfzercoin_pt.ts \
                src/qt/locale/pfzercoin_ru.ts \
                src/qt/locale/pfzercoin_sk.ts \
                src/qt/locale/pfzercoin_sv.ts \
                src/qt/locale/pfzercoin_vi.ts \
                src/qt/locale/pfzercoin_zh_CN.ts \
                src/qt/locale/pfzercoin_zh_TW.ts

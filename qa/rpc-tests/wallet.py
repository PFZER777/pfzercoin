...
#   c) node1 mines 32 blocks, so now node 0 has 60001PFZR, node 1 has 4250PFZR, node2 has none.
#   d) node0 sends 601 PFZR to node2, in two transactions (301 PFZR, then 300 PFZR).
